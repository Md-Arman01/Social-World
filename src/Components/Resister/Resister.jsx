            ...
            <h1 className="text-red-500 px-5">password minimus 6 letter and one more capital letter and also special carecter</h1>
              <div className="inline-flex items-center">
                <label
                  ...
                  <input
                    type="checkbox"
                    className="before:content[''] peer relative h-5 w-5 cursor-pointer appearance-none rounded-md border border-blue-gray-200 transition-all before:absolute before:top-2/4 before:left-2/4 before:block before:h-12 before:w-12 before:-translate-y-2/4 before:-translate-x-2/4 before:rounded-full before:bg-blue-gray-500 before:opacity-0 before:transition-opacity checked:border-[#97245F] checked:bg-[#97245F] checked:before:bg-[#97245F] hover:before:opacity-10"
                    id="checkbox"
                  />
